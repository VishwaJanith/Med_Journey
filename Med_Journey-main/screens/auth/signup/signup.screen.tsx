...
export default function SignUpScreen() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      setRequired((error as { message: string }).message);
    } finally {
    ...
    >
      <ScrollView>
        ...
        <Text style={styles.learningText}>
          Create an account to MedJourney to get all features
        </Text>
        <View style={styles.inputContainer}>
          <View>
            <TextInput
              style={[styles.input, { paddingLeft: 40, marginBottom: -13 }]}
          ...
          <View>
            <TextInput
              style={[styles.input, { paddingLeft: 40,marginTop:8 }]}
            ...
            />
            <Fontisto
              style={{ position: "absolute", left: 26, top: 25.8 }}
              name="email"
              size={20}
              color={"#A1A1A1"}
            />
